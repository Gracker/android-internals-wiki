...
- [第 4 章：内存管理](part1-fundamentals/ch04-memory/README.md)
  ...
  - [4.5 Android 17 后台任务内存配额机制 — MemoryLimiter 与 cgroup memory.high](2026-06-26-19-知识加工(新).md)
  - [4.6 App 内存优化](part1-fundamentals/ch04-memory/05-app-memory-optimization.md)
...
- [27.1 Camera HAL3 Buffer 管理深度解析](part3-tools/ch27-camera-hal3/27.3-camera-hal3-buffer-management.md)
- [27.2 Android 应用分发与内容共享机制](part3-tools/ch27-app-distribution/27.2-android-app-distribution-mechanism.md)
- [27.3 CameraX ZSL 与 HAL Reprocessing Request 映射实战](part3-tools/ch27-camerax-zsl/27.4-camerax-zsl-mapping.md)
- [27.4 性能工程成熟度模型](part3-tools/ch27-performance-engineering/01-maturity-model.md)
- [27.5 性能策略制定与路线图](part3-tools/ch27-performance-engineering/02-performance-strategy.md)
- [27.6 性能预算体系](part3-tools/ch27-performance-engineering/03-performance-budget.md)
- [27.7 左移性能工程](part3-tools/ch27-performance-engineering/04-shift-left.md)
- [27.8 持续性能验证与 CI/CD](part3-tools/ch27-performance-engineering/05-cicd-continuous-perf.md)
- [27.9 性能文化构建与团队演进](part3-tools/ch27-performance-engineering/06-culture-team.md)
