...
- [第 3 章：输入系统](part1-fundamentals/ch03-input/README.md)
  ...
  - [触摸响应的性能分析](part1-fundamentals/ch03-input/02-touch-performance.md)
  ...
  - [输入事件拦截与安全机制](part1-fundamentals/ch03-input/05-input-interception-security.md)
  - [手势识别算法与性能优化](part1-fundamentals/ch03-input/06-gesture-recognition-performance.md)
  ...
  - [Predictive Back 系统架构与动画管线性能](part1-fundamentals/ch03-input/12-predictive-back-system-architecture.md)
  - [3.13 键盘、鼠标与指针输入性能 — 桌面模式交互管线](part1-fundamentals/ch03-input/13-keyboard-mouse-pointer-input-performance.md)
  - [3.14 Input 系统参考文献](part1-fundamentals/ch03-input/参考资料.md)
