...
- [第 1 章：系统架构全景](part1-fundamentals/ch01-architecture/README.md)
  ...
  - [1.33 Android 17 Binder 线程池实现机制与调优参数](part1-fundamentals/ch01/01.33-gap-analysis.md)
  ...
  - [1.61 Android 17 TelephonyManager 架构与性能优化](part1-fundamentals/ch01-architecture/1.61-android17-telephonymanager-architecture-performance.md)
  - [1.62 Android 17 ConnectivityManager 架构与性能优化](part1-fundamentals/ch01-architecture/1.62-android17-connectivitymanager-architecture-performance.md)
...
- [2.5 Compose Pager 从基础到高级动画](2.5-compose-pager-advanced-animations.md)
  ...
  - [2.11 Android 17 GPU 图形调试与性能优化工具链](part1-fundamentals/ch02/11-gap-analysis.md)
  ...
  - [2.6 Android 17 eBPF观测增强](part2-implementation/ch02-rendering/2.6-ebpf-observability-enhancement/2.6-ebpf-observability-enhancement.md)
  - [2.7 Android 17 GPU 图形调试与性能优化工具链](part2-implementation/ch02-rendering/2.7-gpu-debug-performance-tools-chain/2.7-gpu-debug-performance-tools-chain.md)
...
- [4.43 Android 17 LMKD 用户态迁移 + PSI 协同机制源码级调研](part1-fundamentals/ch04/04.43-gap-analysis.md)
- [4.44 Android 17 AI Agent 内存沙箱化与跨应用数据复用](part1-fundamentals/ch04/04.44-gap-analysis.md)
...
- [第 6 章：存储性能](part1-fundamentals/ch06-storage/README.md)
  ...
  - [6.4 Android 17 SharedPreferencesImpl ANR 真因分析与迁移方案](part1-fundamentals/ch06-storage/6-4-android17-sharedpreferencesimpl-anr-真因分析与迁移方案.md)
  - [4.11 Android 17 AppFlow 与 LMKD v2 内存联合调度协作机制](part1-fundamentals/ch04-memory/4-11-android17-appflow-与-lmkd-v2-内存联合调度协作机制.md)
...
- [8.1 Android 17 任务调度器优化](8.1-android17-task-scheduler-optimization.md)
...
- [5.29 Android 17 GPU DVFS Headroom 与 SurfaceFlinger PowerAdvisor 链路](part1-fundamentals/ch05-cpu-power/5.29-android17-gpu-dvfs-headroom-power-advisor.md)
  ...
  - [8.3 Android 17 Startup Insights 缺口分析](part1-fundamentals/ch08-startup/8.3-startup-insights-gaps.md)
  ...
  - [8.3 Android 17 系统启动优化与 bootanalyze 工具链增强](part2-performance/ch08-responsiveness/8-3-android17-系统启动优化与-bootanalyze-工具链增强.md)
  ...
  - [11.1 Android 17 网络性能优化实战](part2-performance/ch11-network-optimization/11.1-android17-network-performance.md)

  - [9.2 ANR 类型与触发条件](part2-performance/ch09-anr/02-anr-types.md)
  - [9.3 ANR 分析方法](part2-performance/ch09-anr/03-anr-analysis.md)
  - [9.7 非技术性 ANR 诊断](part2-performance/ch09-anr/07-non-technical-anr-diagnosis.md)
  - [9.10 Android 17 ANR 预警回调与类型枚举](part2-performance/ch09-anr/10-android17-anr-warning-callback.md)
...
#   - [8.33 Android 17 模块化启动框架与依赖图优化](part1-fundamentals/ch08-startup/8.33-android17-modular-startup-dependency-graph.md)
