...
task6_result: pass-light-edit-rework
task9_state: pending
...
last_task9_reviewed_by: "openclaw-task6"
last_task9_issues: "P0:1 P1:2 P2:5"
last_task6_at: "2026-06-27T23:11:41+08:00"
...
`BINDER_VM_SIZE` 在 android-17.0.0_r1 仍为 1MB。RPC Binder（`libbinder/RpcSession.cpp`）的 `kDefaultRpcBinderSize` 从 ~100KB 扩到了 ~600KB。这是两套独立的缓冲区系统，与主 Binder IPC 的 1MB 共享 mmap 无关。
