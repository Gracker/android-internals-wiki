...
在 Framework 层，`ThermalManagerService` 是温控系统的中枢。Android 16 及更低版本上它的源码位于 `frameworks/base/services/core/java/com/android/server/power/ThermalManagerService.java`；Android 17 起迁移到 `frameworks/base/services/core/java/com/android/server/power/thermal/`，包名相应变为 `com.android.server.power.thermal`。它做三件事：
