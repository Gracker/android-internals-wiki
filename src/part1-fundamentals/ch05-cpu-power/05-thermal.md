...
task6_reviewed_date: "2026-06-06"
last_task6_at: "2026-06-06T08:13:23+08:00"
last_task6_audit: "2026-05-26"
last_task6_audit_log: "logs/review/2026-05-26-06-audit.md"
last_task6_review_log: "logs/review/2026-06-06-08-review.md"
task9_state: reviewed
task9_result: auto-fixed
task9_reviewed_date: "2026-06-06"
task9_reviewed_by: "openclaw-task9"
last_task9_at: "2026-06-23T04:34:48+08:00"
...
Android 的温控是一个分层架构：从底层硬件传感器一直到上层 Framework 服务，组成了一条完整的管控路径。逐层来看。
...
在 Framework 层，`ThermalManagerService` 是温控系统的中枢。Android 16 及更低版本源码路径是 `frameworks/base/services/core/java/com/android/server/power/ThermalManagerService.java`；Android 17 路径迁移到 `frameworks/base/services/core/java/com/android/server/power/thermal/ThermalManagerService.java`，package 也变为 `com.android.server.power.thermal`。它做三件事：
...
温控触发条件都与“负载产生了多少热量”直接相关。反过来看：如果硬件本身因为某些原因做了更少的无用功，热量积累就会变慢。16KB 大页内存对温控可能存在间接贡献，但当前缺乏同设备 4KB/16KB A/B 对照数据（thermal zone 温度曲线、CPU 频率上限变化、time-to-throttle、功耗 rail 读数），以下为研究假设而非已验证结论。
...
### AOSP 源码
- Android 16 及更低：`frameworks/base/services/core/java/com/android/server/power/ThermalManagerService.java` — Framework 温控服务 [已验证]
- Android 17：`frameworks/base/services/core/java/com/android/server/power/thermal/ThermalManagerService.java` — Framework 温控服务路径迁移 [已验证]
