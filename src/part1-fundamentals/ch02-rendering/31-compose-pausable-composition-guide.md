...
Compose Runtime 的对象模型、状态机、`RecordingApplier` 与 Lazy Layout 预取的公共边界，可配合[第 22 章 Compose 性能优化](../../part5-app/ch22-rendering-practice/03-compose-performance.md)阅读；本文聚焦应用侧的使用和测量。
...
- [第 22 章 Compose 性能优化](../../part5-app/ch22-rendering-practice/03-compose-performance.md)：Runtime 状态机、`RecordingApplier`、Lazy Layout 预取与应用级 Compose 性能边界
