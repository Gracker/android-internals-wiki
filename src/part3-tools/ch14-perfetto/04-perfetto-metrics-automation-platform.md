...
- type: internal
  path: src/part3-tools/ch14-perfetto/09-perfetto-sql-cookbook.md
- type: internal
  path: src/part3-tools/ch14-perfetto/15-agent-perfetto-analysis-protocol.md
- type: internal
  path: src/part3-tools/ch14-perfetto/16-perfetto-sdk-in-app-tracing.md
- type: internal
...
consolidated_from:
- src/part3-tools/ch14-perfetto/06-advanced-usage.md
- src/part3-tools/ch14-perfetto/17-smartperfetto-trace-analysis-platform.md
---
...
14.7 的 SQL 查询条件、单位与 Jank/CUJ 查询，14.11 的调查协议，以及 26.4 的回归判定可以转为 Skill contract。contract 应声明输入、输出、单位、证据解释、适用版本、缺失数据分支和人工复核入口。
