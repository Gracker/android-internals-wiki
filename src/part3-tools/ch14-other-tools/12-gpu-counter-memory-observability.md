...
consolidated_from:
- src/part3-tools/ch14-other-tools/16-gpu-performance-profiling-advanced.md
...
§10.4 讨论应用与图形内存症状，§14.11 介绍 GPU 调试工具，§14.16 展开 eBPF 观测范围。这里的范围限于 GpuService、GPU memory tracepoint、GpuStats 和 DMA-BUF 对账之间的接口关系。
