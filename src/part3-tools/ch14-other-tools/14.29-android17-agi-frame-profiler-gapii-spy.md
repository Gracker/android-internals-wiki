...
截至 2026 年 7 月 29 日，GitHub Releases 的最新稳定版仍是 AGI `v3.3.3`，对应 commit `5f97b4fd99a9459320b782203ce2de5351a1e661`，发布于 2025 年 1 月 20 日。本章用这个 release commit 核对工具内部实现，再用更新至 2026 年 5 月 19 日的 Android Developers 文档核对当前支持流程。AGI 二进制版本和 Android OS 版本互相独立；复现实验时应同时记录二者。
