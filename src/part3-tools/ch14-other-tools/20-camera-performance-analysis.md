...
- type: internal-reference
  path: src/part1-fundamentals/ch02-rendering/32-camera-hal3-buffer-management.md
- type: internal-reference
  path: src/part1-fundamentals/ch02-rendering/33-camerax-zsl-hal-mapping.md
- type: aosp
