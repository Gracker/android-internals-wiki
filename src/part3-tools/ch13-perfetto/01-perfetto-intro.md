...
task9_review_notes: "2026-05-25 Task9 deep-review: needs-rework。P0 1 / P1 1 / P2 0。Trace Processor metric 示例包含不可用的 android_jank；logcat in trace 的 userdebug 边界缺失。2026-05-28 Task2B fallback 已修复 metric 名、android.log userdebug 边界与 Android 10/11 normal mode 配置输入边界，回流 Task6/Task9。 2026-05-28 Task9 deep-review: pass-tech-review。P0 0 / P1 0 / P2 0。Task6 已通过且 queue 无 pending，自动晋升 finalized。"
...
[源码验证: lmkd.cpp (android-17.0.0_r1), Perfetto ftrace parser — instant.name='mem.lmk', Perfetto 官方 memory counters 文档]
