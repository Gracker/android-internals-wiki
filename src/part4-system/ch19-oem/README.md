...
- [19.1 OEM 性能优化与应用协作](01-oem-performance-app-collaboration.md)
- [19.2 SoC 平台差异](02-soc-differences.md)
- [19.3 OEM 调度、游戏模式与输入优先级](03-oem-scheduling-game-input.md)
- [19.4 Power HAL、schedutil 与 Power Stats](04-power-hal-schedutil-power-stats.md)
- [19.5 Media Performance Class 与设备能力分级](05-media-performance-class-device-capability.md)
- [19.6 Private Space 与应用锁的兼容性边界](06-private-space-app-lock-boundary.md)
- [19.7 Android Auto 与 Android Automotive OS 性能优化](07-android-auto-car-os-performance.md)
