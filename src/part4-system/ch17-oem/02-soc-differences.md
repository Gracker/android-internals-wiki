...
task2b_result: fixed
last_task2b_at: "2026-05-10T10:43:34+08:00"
---
...
**Scheduling Track**：这是差异最小的部分，因为 Android 统一使用基于 Linux CFS/EEVDF 的调度器。但各厂商的 schedutil 调频策略、uclamp 配置和 cgroup 设置不同，会导致相同的负载在不同设备上表现出不同的频率曲线。
