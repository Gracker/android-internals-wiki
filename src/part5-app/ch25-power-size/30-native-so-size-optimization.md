...
本章以 Android 17 / API 37 / `android-17.0.0_r1` 为平台锚点；涉及文件映射与基础页时，以 `android17-6.18-2026-06_r6` 为内核锚点。NDK、AGP 和 Google Play 规则采用 2026 年 7 月的官方文档语义。构建工具版本与 Android 平台版本是两条独立轴，升级 `targetSdk` 不会自动缩小 `.so`。
