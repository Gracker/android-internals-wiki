...
- [25.11 App Bundle 与按需分发](11-app-bundle-delivery.md)：基础模块、动态特性模块与设备专用 APK。
- [21.4 Baseline、Startup 与 Cloud Profile 编译优化](../ch21-startup/04-baseline-startup-cloud-profile.md)：主 DEX 布局、配置文件生成与启动验证。
- [1.4 Java 类加载与 ART Boot Image](../../part1-fundamentals/ch01-architecture/04-class-loading-art-boot-image.md)：`.art`、`.oat`、`.vdex` 与平台启动边界。
...
- [25.11 App Bundle 与按需分发](11-app-bundle-delivery.md)：ABI 配置 APK 与动态特性模块。
- [4.5 16 KB Page Size 与 Android 性能](../../part1-fundamentals/ch04-memory/05-16kb-page-size.md)：ELF/ZIP 检查、兼容模式和故障归因。
- [1.7 Dynamic Linker、VNDK 与 Native 库隔离](../../part1-fundamentals/ch01-architecture/07-dynamic-linker-vndk-isolation.md)：平台 Native 可见性，以及 linker64 加载、重定位、RELRO 与 namespace。
...
- [25.11 App Bundle 与按需分发](11-app-bundle-delivery.md)：配置 APK、Dynamic Feature 与 PAD 的交付边界。
