...
last_draft_polish_at: "2026-07-26T11:35:06+08:00"
last_draft_polish_run_id: "20260726-113506-draft-polish-43dea43a"
task6_state: "blocked-source-material-required"
task9_state: "pending"
pipeline_stage: "draft_needs_body_apply"
last_verified: "2026-07-26"
last_verified_against: "Android baseline android-17.0.0_r1; no routed source materials in draft-polish run"
confidence: low
sources:
  - type: source-material-required
    note: "Pre-run materials array was empty; body is intentionally constrained to review scaffolding and source requests."
---

# Android 17 NetworkStatsService 与 NetworkPolicyManagerService 移动数据 quota 限速源码路径

> **Draft-polish 结论（2026-07-26）**：本轮没有路由到 AOSP 源码切片、官方文档、设备 trace、代码搜索结果或前序 body-apply 材料。原稿包含大量未标注来源的伪代码、类名与 API 断言，不能在 `android-17.0.0_r1` 基线上作为已验证源码结论保留。因此本章保持 `draft`，先收敛为可复查的章节骨架与材料清单，等待 body-apply/source-material 补齐后再进入 `ready-for-review`。
