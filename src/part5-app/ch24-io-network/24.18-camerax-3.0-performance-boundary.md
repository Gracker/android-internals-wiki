...
[14.9 Camera 性能分析](../../part3-tools/ch14-other-tools/09-camera-performance-analysis.md) 给出了 Android 17 的 Perfetto 配置、CameraService open、stream 首缓冲区、请求延迟 histogram 与 ZSL 时间边界，可直接沿用其采集配置。
