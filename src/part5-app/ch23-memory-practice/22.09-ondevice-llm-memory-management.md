...
本文以 Android 17 / API 37 / `android-17.0.0_r1` 为平台锚点；涉及 `/proc` 与页回收语义时，以 `android17-6.18-2026-06_r6` 为内核锚点。LiteRT、MediaPipe LLM Inference 等属于独立发布的库，能力要按项目锁定的库版本和目标设备验证，不能从 Android API level 推导。
