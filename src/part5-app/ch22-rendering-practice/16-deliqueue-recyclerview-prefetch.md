...
related_chapters: ["1.13", "7.8", "13.13", "19.9", "22.2"]
...
FrameTimeline 与 CUJ 的字段用法见 [13.13 Perfetto DataGrid 与 Jank CUJ](../../part3-tools/ch13-perfetto/13-perfetto-data-explorer-jank-cuj.md)，JankStats 场景标记见 [19.9 JankStats 与 FrameMetrics](../../part3-tools/ch19-apm/09-jankstats-framemetrics.md)。第三方应用不会自动获得完整的系统 CUJ 业务名称，需要自己维护 state。
...
- [19.9 JankStats 与 FrameMetrics](../../part3-tools/ch19-apm/09-jankstats-framemetrics.md)：应用侧帧状态、阶段数据与线上分桶。
