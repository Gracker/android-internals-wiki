...
本文的平台源码固定为 Android 17 / API 37 / `android-17.0.0_r1`，kernel 图形内存与 fence 观察固定为 `android17-6.18-2026-06_r6`。Hardware Bitmap 从 API 26 引入，版本沿革只用于解释兼容行为。图片加载、Bitmap 内存与公共显示管线分别见 [22.6 图片加载](06-image-loading.md)、[23.2 Bitmap 内存优化](../ch23-memory-practice/02-bitmap-optimization.md) 和 [18.2 Android View 标准管线](../../part2-performance/ch18-rendering-pipelines/02-android-view-standard.md)。
