...
本文的平台能力以 Android 17 / API 37 / `android-17.0.0_r1` 为上界。远程日志、用户反馈与灰度控制属于应用架构；`ApplicationExitInfo`、`ProfilingManager` 和 StatsD 的版本与权限结论按 Android 17 复核。本节没有依赖内核实现的结论，因此不附加 Android 17 kernel tag。
...
[已验证: AOSP android-17.0.0_r1, frameworks/base/core/res/AndroidManifest.xml]
[已验证: AOSP android-17.0.0_r1, packages/modules/StatsD/service/java/com/android/server/stats/StatsManagerService.java]
<!-- /AIW-源码调研-2026-06-07 -->
...
[已验证: AOSP android-17.0.0_r1, packages/modules/StatsD/service/java/com/android/server/stats/StatsManagerService.java]
[已验证: AOSP android-17.0.0_r1, packages/modules/StatsD/statsd/src/main.cpp]
<!-- /AIW-源码调研-2026-06-08 -->
