...
普通线上进程没有权限读取完整系统 trace。实验室可以结合 Perfetto、SystemUI 日志、`system_server` 轨迹和厂商 HAL 日志定位；线上证据能力与权限分级见 [§26.10 版本化诊断](../../part5-app/ch26-observability/10-versioned-diagnostics.md)。
