...
响应速度是指用户在界面上进行操作（如点击、滑动、输入等）后，到系统产生相应视觉反馈所需的时间。这个延迟时间是用户体验的核心指标，直接影响用户对应用流畅性的感知。[已验证: 官方文档, developer.android.com/topic/performance/vitals]
