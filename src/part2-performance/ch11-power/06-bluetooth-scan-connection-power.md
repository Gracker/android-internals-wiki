...
若 Bluetooth rail 上升而 audio DSP rail 保持稳定，才有理由继续检查无线链路。设备没有独立 rail 时，可用 A/B 场景控制变量：保持音量、Codec、媒体内容、屏幕状态和网络缓存相同，只改变耳机链路或头动追踪开关。媒体处理链细节见 8.8，整机功耗模型见 11.1。
