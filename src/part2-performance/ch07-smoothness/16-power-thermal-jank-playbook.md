...
平台源码锚点为 Android 17 / API 37 / `android-17.0.0_r1`，内核事件以 `android17-6.18-2026-06_r6` 为准。厂商的温度阈值、传感器名称、功率预算、GPU 计数器和 power rail 属于设备实现，不能从 AOSP tag 推导某款量产机的具体数值。
