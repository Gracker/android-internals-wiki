...
本章以 Android 17 / API 37 / `android-17.0.0_r1` 为平台基线，依次说明帧时间语义、诊断证据和常见优化边界。涉及调度、功耗和温控时，内核基线为 `android17-6.18-2026-06_r6`。目标是让读者从“界面感觉很卡”走到可复现、可归因、可验证的结论。
...
- 刚开始系统学习流畅性时，按 `7.1 → 7.2 → 7.3` 阅读，先建立帧时间、根因和证据之间的关系。
