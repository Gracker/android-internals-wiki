...
## [Task9 Deep Review] 16.5 Android 17 (API 37) 性能行为变更与适配方法 — 2026-04-28
- **类型**：数据缺失
- **位置**：L388-L393「16KB 页面大小」
- **问题**：FFmpeg、OpenCV、SQLite、RocksDB 等“已知案例”没有版本号、issue 链接或官方迁移文档支撑，读者无法判断是历史版本问题、特定构建参数问题还是当前通用风险。
- **建议**：补具体版本/issue/官方文档；若没有一手证据，改成风险类别，避免把库名写成确定故障清单。

## [External Review] 2.2 帧率与刷新率
- **严重级别**：P1
- **位置**：App 参与决策 / 常见问题
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-02-framerate-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：Perfetto 特征
- **建议**：补充 ARR 模式下 VSync 步长动态变化且无 Mode Switch 阻塞的读图技巧。
- **来源**：2026-04-28-15-ch02-02-framerate-external-review.md


## [External Review] 2.3 VSync 机制
- **严重级别**：P1
- **位置**：算法、过滤及分发小节
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-03-vsync-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：调试开关
- **建议**：补充 debug.sf.vsp_trace 属性用于观测拟合优度。
- **来源**：2026-04-28-15-ch02-03-vsync-external-review.md


## [External Review] 2.4 Choreographer 与渲染流水线
- **严重级别**：P1
- **位置**：监控指标与 Compose 适配
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-04-choreographer-external-review.md` — 2026-04-28

- **类型**：原理链完整性
- **位置**：DeliQueue 联动
- **建议**：提及 Android 17 无锁队列对同步屏障（Sync Barrier）投递抖动的优化。
- **来源**：2026-04-28-15-ch02-04-choreographer-external-review.md


## [External Review] 2.5 Main Thread 与 RenderThread 协作
- **严重级别**：P1
- **位置**：线程职责与 GPU 渲染小节
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-05-main-render-thread-external-review.md` — 2026-04-28

- **类型**：版本差异
- **位置**：ANGLE 现状
- **建议**：说明 OpenGL ES 通过 ANGLE 运行的新常态，以及由此带来的 Trace 符号变化（gl -> vk）。
- **来源**：2026-04-28-15-ch02-05-main-render-thread-external-review.md


## [External Review] 2.6 SurfaceFlinger 与合成
- **严重级别**：P1
- **位置**：主循环与合成模式小节
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-06-surfaceflinger-external-review.md` — 2026-04-28

- **类型**：版本差异
- **位置**：Graphite 引擎
- **建议**：提及 RenderEngine 向下一代 Skia Graphite 引擎的演进预览。
- **来源**：2026-04-28-15-ch02-06-surfaceflinger-external-review.md


## [External Review] 2.7 Hardware Layer
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-07-hardware-layer-external-review.md` — 2026-04-28

- **类型**：原理链完整性
- **位置**：异步构建
- **建议**：提及 HardwareRenderer.buildLayer 在 Android 16 中的异步非阻塞特性。
- **来源**：2026-04-28-15-ch02-07-hardware-layer-external-review.md


## [External Review] 2.8 过度绘制与层级压平
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-08-overdraw-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：16KB 带宽
- **建议**：提及 16KB 页大小带来的带宽冗余对 Overdraw 压力的“软垫”效应。
- **来源**：2026-04-28-15-ch02-08-overdraw-external-review.md


## [External Review] 2.9 渲染机制的版本演进
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-09-rendering-evolution-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：Android 17 前瞻
- **建议**：提及 Native WebGPU 的引入如何进一步统一 Web 与原生的高性能计算栈。
- **来源**：2026-04-28-15-ch02-09-rendering-evolution-external-review.md


## [External Review] 2.10 GPU 渲染深入
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-10-gpu-rendering-external-review.md` — 2026-04-28

- **类型**：版本差异
- **位置**：Vulkan 1.4 同步
- **建议**：提及 Synchronization 2 机制对 RenderThread 指令提交开销的优化。
- **来源**：2026-04-28-15-ch02-10-gpu-rendering-external-review.md


## [External Review] 2.11 Flutter 渲染管线与性能
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-11-flutter-rendering-external-review.md` — 2026-04-28

- **类型**：版本差异
- **位置**：演进前瞻
- **建议**：提及 Flutter 4.0 彻底转向 Impeller 的路线图及对 WebGPU 计算能力的集成。
- **来源**：2026-04-28-15-ch02-11-flutter-rendering-external-review.md


## [External Review] 2.12 Window Manager Service 与窗口管理
- **严重级别**：P1
- **位置**：配置变更与布局逻辑小节
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-12-window-manager-external-review.md` — 2026-04-28

- **类型**：原理链完整性
- **位置**：状态缓存
- **建议**：提及桌面持久化机制对减少 relayoutWindow 往返次数的正面影响。
- **来源**：2026-04-28-15-ch02-12-window-manager-external-review.md


## [External Review] 2.13 图形缓冲区管理 (BufferQueue)
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-13-buffer-queue-external-review.md` — 2026-04-28

- **类型**：知识盲区
- **位置**：16KB 页红利
- **建议**：提及 16KB 页下 GraphicBuffer 映射导致的页错误频率下降 75% 的数据。
- **来源**：2026-04-28-15-ch02-13-buffer-queue-external-review.md


## [External Review] 2.14 图形 API 演进与选择策略
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-14-graphics-api-evolution-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：16KB 内存
- **建议**：提及 NDK r28 对 max-page-size 的对齐要求及其对显存池化管理的影响。
- **来源**：2026-04-28-15-ch02-14-graphics-api-evolution-external-review.md


## [External Review] 2.15 DMA-BUF、Gralloc 与跨进程图形内存共享
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-15-dmabuf-gralloc-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：16KB 红利
- **建议**：提及大页内存减少 75% Page Fault 对 importBuffer 初始性能的量化贡献。
- **来源**：2026-04-28-15-ch02-15-dmabuf-gralloc-external-review.md


## [External Review] 2.16 Sync Fence 框架与帧同步机制
- **严重级别**：P1
- **位置**：核心机制、渲染路径及版本演进小节
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-16-sync-fence-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：多屏 Fence
- **建议**：提及 FrameTargeter 在多屏异步场景下利用 Fence Merge 缓解“副屏拖慢主屏”现象的细节。
- **来源**：2026-04-28-15-ch02-16-sync-fence-external-review.md


## [External Review] 2.17 Frame Pacing Library 与帧节奏控制
- **严重级别**：P1
- **位置**：提交链、接入细节及演进趋势小节
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-17-frame-pacing-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：Headroom 联动
- **建议**：补充 Swappy 配合 Android 16 GPU Headroom API 执行主动限帧以预防过热的机制。
- **来源**：2026-04-28-15-ch02-17-frame-pacing-external-review.md


## [External Review] 2.18 Adaptive Refresh Rate 与动态帧率控制
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-18-adaptive-refresh-rate-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：多屏同步
- **建议**：提及 ARR 在外接显示器场景下需强制对齐 Pacesetter 时钟的约束。
- **来源**：2026-04-28-15-ch02-18-adaptive-refresh-rate-external-review.md


## [External Review] 2.19 刷新率切换与帧率适配性能
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-19-refresh-rate-switching-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：旗舰 SoC 表现
- **建议**：补充骁龙 8 Elite 凭借切片 DPU 架构实现 0-1 帧无缝切换的实测结论。
- **来源**：2026-04-28-15-ch02-19-refresh-rate-switching-external-review.md


## [External Review] 2.20 多窗口与桌面模式渲染性能
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-20-multiwindow-desktop-rendering-external-review.md` — 2026-04-28

- **类型**：原理链完整性
- **位置**：iPiP 机制
- **建议**：提及 Android 17 交互式画中画利用 Pinned Layer 锁实现的性能优先级隔离。
- **来源**：2026-04-28-15-ch02-20-multiwindow-desktop-rendering-external-review.md


## [External Review] 2.21 文字渲染性能
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch02-21-text-rendering-performance-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：16KB 局部性
- **建议**：提及大页内存带来的 2-3% 文本塑形吞吐量增益。
- **来源**：2026-04-28-15-ch02-21-text-rendering-performance-external-review.md


## [External Review] 3.1 Input 事件分发全流程
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch03-01-input-dispatch-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：dumpsys 增强
- **建议**：提及 Android 16 中 dumpsys input 对连接三态 (NORMAL/BROKEN/ZOMBIE) 的更精细化展示。
- **来源**：2026-04-28-15-ch03-01-input-dispatch-external-review.md


## [External Review] 3.2 触控性能优化
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch03-02-touch-performance-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：监控标准
- **建议**：提及 Android Vitals 标准化的 24ms 高输入延迟指标。
- **来源**：2026-04-28-15-ch03-02-touch-performance-external-review.md


## [External Review] 3.3 手势导航与系统交互
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch03-03-gesture-navigation-external-review.md` — 2026-04-28

- **类型**：原理链完整性
- **位置**：动画脱离
- **建议**：提及 BackPanel 动画已移至 WM Shell 独立渲染以抵御系统卡顿。
- **来源**：2026-04-28-15-ch03-03-gesture-navigation-external-review.md


## [External Review] 3.4 输入延迟与预测输入技术
- **严重级别**：P1
- **位置**：调度优化、量化工具及采样策略小节
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch03-04-input-latency-prediction-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：16KB 传输红利
- **建议**：提及大页内存减少 75% Page Fault 对高频输入 IPC 确定性的加成（约 3%）。
- **来源**：2026-04-28-15-ch03-04-input-latency-prediction-external-review.md


## [External Review] 4.1 Android 内存模型全景
- **严重级别**：P1
- **位置：**内核管理、物理内存及指标分析小节
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch04-01-memory-overview-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：DeliQueue 收益
- **建议**：提及 Android 17 无锁队列对内存压力回调实时性的提升。
- **来源**：2026-04-28-15-ch04-01-memory-overview-external-review.md


## [External Review] 4.2 Linux 内核内存管理
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch04-02-linux-memory-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：eBPF 监控
- **建议**：提及 Android 16 内置的 eBPF DMA-BUF 统计机制，它是解决 GPU 内存归属争议的标准工具。
- **来源**：2026-04-28-15-ch04-02-linux-memory-external-review.md


## [External Review] 4.3 ART 虚拟机内存管理
- **严重级别**：P1
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch04-03-art-memory-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：MemoryLimiter 联动
- **建议**：提及 Android 17 新增的 ApplicationExitInfo 描述字段对 ART 堆溢出的精确判责。
- **来源**：2026-04-28-15-ch04-03-art-memory-external-review.md


## [External Review] 4.4 Low Memory Killer
- **严重级别**：P1
- **位置**：回收策略、厂商定制及版本演进小节
...
## 十一、落盘信息
- 已写入文件：`logs/external-review/2026-04-28-15-ch04-04-lmk-external-review.md` — 2026-04-28

- **类型**：数据/案例支撑
- **位置**：16KB 回收效率
- **建议**：补充 16KB 页减少 75% 页表遍历开销从而加速进程释放的量化数据。
- **来源**：2026-04-28-15-ch04-04-lmk-external-review.md

- **类型**：数据/案例支撑
- **位置**：04.05
- **建议**：提及 Glide v5 对 16KB 页对齐的内部优化，以减少缓冲区浪费。
- **来源**：2026-04-28-15-ch04-05-app-memory-optimization-external-review.md


- **类型**：数据/案例支撑
- **位置**：04.06
- **建议**：提及 Android 17 引入的 madvise(MADV_COLD) 协同使多任务 Stall 降低 15% 的量化收益。
- **来源**：2026-04-28-15-ch04-06-memory-evolution-external-review.md


- **类型**：数据/案例支撑
- **位置**：04.07
- **建议**：提及 VPA16 强制要求的 16384 字节最小映射对齐，作为 16KB 适配的图形基准。
- **来源**：2026-04-28-15-ch04-07-16kb-page-size-external-review.md


- **类型**：数据/案例支撑
- **位置**：05.01
- **建议**：提及 Android 17 通过 sched_ext 支持 eBPF 动态调度器，实现了调度逻辑的非内核重编下发。
- **来源**：2026-04-28-15-ch05-01-linux-scheduling-external-review.md


- **类型**：数据/案例支撑
- **位置**：05.02
- **建议**：提及 Proxy Execution 如何帮助 EAS 识别锁阻塞路径上的“潜伏”能效瓶颈。
- **来源**：2026-04-28-15-ch05-02-eas-external-review.md


- **类型**：数据/案例支撑
- **位置**：05.03
- **建议**：提及 Android 17 利用 eBPF 调度器在全大核设备上实施的场景化亲和性定制策略。
- **来源**：2026-04-28-15-ch05-03-big-little-external-review.md


- **类型**：数据/案例支撑
- **位置**：05.04
- **建议**：提及利用 devfreq 轨道量化内存频率跳变对 16KB 页大数据流转性能的影响。
- **来源**：2026-04-28-15-ch05-04-dvfs-external-review.md


- **类型**：数据/案例支撑
- **位置**：05.05
- **建议**：提及 HWC 4.0 静态刷新节电对释放 CPU 热空间的间接贡献。
- **来源**：2026-04-28-15-ch05-05-thermal-external-review.md


- **类型**：数据/案例支撑
- **位置**：05.06
- **建议**：提及 Gemini Nano 如何通过上下文预测用户行为，从而实现后台任务的“零唤醒”合并。
- **来源**：2026-04-28-15-ch05-06-android-power-external-review.md
...
## [Task9 Deep Review] 1.1 Android 分层架构 — 2026-04-28
- **类型**：数据缺失
- **位置**：L181、L244、L255、L273
- **问题**：Zygote fork 20-50ms、Binder 10-100μs、AVC 50-200ns、FastNative/CriticalNative ns 级数据仍主要依赖社区测量或内部基准，正文已有待验证标记但缺少设备/版本/样本口径。
- **建议**：保留待验证标记，后续补 Pixel / 目标机型 trace、microbenchmark 或官方/论文来源；无法补齐时把数值改成量级描述。

## [Task9 Deep Review] 11.4 案例集 — 2026-04-28
- **类型**：数据缺失
- **位置**：案例一/二/三/四/五效果对比表
...
## [Task9 Deep Review] 5.4 DVFS 与功耗管理 — 2026-04-29
- **类型**：数据缺失
- **位置**：L109-L115（4GHz 能效红线）
- **问题**：正文给出 3.5-3.8GHz 限频只损失 5-10% 单核算力、整机功耗降低 20-30% 等精确范围，但没有设备、SoC、内核、环境温度、benchmark 或原始功耗曲线。
- **建议**：补充可复核的 V/F 表、功耗采样和 benchmark 条件；没有来源时保留“高频段能效迅速变差”的定性结论，删除精确比例。

## [Task9 Deep Review] 5.5 Thermal 管控 — 2026-04-29
- **类型**：数据缺失
- **位置**：L404-L410（16KB Page Size 对热平衡的底层加持）
- **问题**：正文把“MMU 功耗降低约 4.5%”进一步推导为“延长最高频时间窗”，但缺少设备、负载、温度曲线和 4KB/16KB 对照实验；当前只标 `[待验证]` 不足以支撑热稳定性结论。
- **建议**：把 4.5% 作为待验证研究线索，移出主结论；若保留，补 Perfetto thermal zone、cpu_frequency、power rail 或厂商功耗实验数据。

## [Task9 Deep Review] 5.5 Thermal 管控 — 2026-04-29
- **类型**：数据缺失
- **位置**：L542-L557（Sustained Performance Mode CTS 指标）
