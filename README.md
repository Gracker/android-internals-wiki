...
- 规范章节正文共 496 篇：`finalized` 333、`ready-for-review` 162、`verified` 1。
- `pipeline_stage=ready-to-publish` 的正文为 276 篇；其余遗留流水线状态按 `metadata/progress.json` 聚合展示。
- `src/SUMMARY.md` 包含 535 个本地链接，链接目标和重复项检查均通过。
